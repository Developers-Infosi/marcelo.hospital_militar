...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $response['doctor'] = Doctor::count();
        $response['nurse'] = Nurse::count();
        $response['patient'] = Patient::count();
        $response['doctors']  =  Doctor::with('specialtie')->paginate(6);

        $response['Patients'] =Patient::orderBy('id', 'desc')->get();
