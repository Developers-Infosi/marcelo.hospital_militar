...
@section('titulo', ' Detalhes do Cargo')

@section('content')
    <form action="{{ url('admin/cargo/delete') }}" method="POST">
        @csrf
                ...
                <div class="card mb-2">
                    <div class="card-body">
                        <h2 class="h5 page-title"><b>
                                <a href="{{ url('admin/cargo/index') }}">Listar Tipo de  Cargos</a>
                                > Detalhes do Cargo - {{ $position->name }}
                ...
                <div class="card shadow mb-2">
                    <div class="card-body">
                        <div class="col-12 mt-2">
                            <h5 class=""><b>Informações do Tipo de Cargo  </b> </h5>
                            <hr>
                        </div>
                        <div class="col-12">
                            <div class="row">
