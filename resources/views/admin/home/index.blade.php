...
@section('titulo', 'Sistema de Gestão Hospitalar')
@section('content')
...
<section class="slider-hero">
    ...
    <div class="hero-slider">
        <div class="item">
            <div class="work">
                <div class="img img2 d-flex align-items-center js-fullheight" style="background-image:url(images/xbg_1.jpg.pagespeed.ic.Vwav95OLtz.jpg)">
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-lg-6">
                                        <div class="text mt-md-5">
                                            <h1 class="mb-4">Dentist Services that You Can Trust</h1>
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-lg-6">
                                        <div class="text mt-md-5">
                                            ...
                                            <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                                            <p><a href="#" class="btn btn-primary p-4 py-3">Make An Appointment <span class="ion-ios-arrow-round-forward"></span></a> <a href="#" class="btn btn-white p-4 py-3">View Course <span class="ion-ios-arrow-round-forward"></span></a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control arrival_date" placeholder="Appointment Date">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
...
<option value="">Dr. Blake Wood</option>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="" id="" cols="0" rows="5" class="form-control" placeholder="Message"></textarea>
                                </div>
                            </div>
                            <div class="col-md-12 d-flex align-items-center">
                                <div class="form-group">
                                    <input type="submit" value="Send message" class="btn btn-white py-3 d-block rounded">
                                </div>
                            </div>
                        </div>
                    </div>
...
<section class="ftco-section ftco-no-pt ftco-no-pb">
    <div class="container-xl">
        <div class="row g-xl-5">
            <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                <div class="img w-100" style="background-image:url(images/xabout.jpg.pagespeed.ic.7iLU70om2_.jpg)">
                </div>
            </div>
            <div class="col-md-6 heading-section d-flex align-items-center" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                <div class="mt-0 my-lg-5 py-5">
                    ...
                    <div class="row section-counter mt-5">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-4 d-flex align-items-stretch">
                            <div class="counter-wrap-2 d-flex" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                                ...
                                <div class="text">
                                    <h2 class="number"><span class="countup">2200</span></h2>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-4 d-flex align-items-stretch">
                            <div class="counter-wrap-2 d-flex" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000">
                                ...
                                <div class="text">
                                    <h2 class="number"><span class="countup">24</span></h2>
    ...
    <div class="container">
        <div class="row justify-content-center pb-4">
            <div class="col-md-7 text-center heading-section" data-aos="fade-up" data-aos-duration="1000">
                <span class="subheading">Our Doctors</span>
                <h2 class="mb-5">Qualified Dentist</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 col-lg-3" data-aos="flip-right" data-aos-delay="100" data-aos-duration="1000">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" style="background-image:url(images/xdoc-1.jpg.pagespeed.ic.jW-_ygGFCU.jpg)"></div>
                    </div>
            ...
            <div class="col-md-6 col-lg-3" data-aos="flip-right" data-aos-delay="100" data-aos-duration="1000">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" style="background-image:url(images/xdoc-2.jpg.pagespeed.ic.5s-tw0yKRw.jpg)"></div>
                    </div>
                    <div class="text text-center">
            ...
            <div class="col-md-6 col-lg-3" data-aos="flip-right" data-aos-delay="100" data-aos-duration="1000">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" style="background-image:url(images/xdoc-3.jpg.pagespeed.ic.WtAu-OkQ3Y.jpg)"></div>
                    </div>
                    <div class="text text-center">
            ...
            <div class="col-md-6 col-lg-3" data-aos="flip-right" data-aos-delay="100" data-aos-duration="1000">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" style="background-image:url(images/xdoc-4.jpg.pagespeed.ic.CfimsGL1-I.jpg)"></div>
                    </div>
                    <div class="text text-center">
...
<section class="ftco-intro-2 img" style="background-image:url(images/xbg_1.jpg.pagespeed.ic.Vwav95OLtz.jpg)">
    <div class="overlay"></div>
    <div class="container-xl">
        <div class="row justify-content-center">
            <div class="col-lg-10 col-xl-10">
                <div class="row" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <div class="col-md-4 d-flex align-items-center">
                        <p class="mb-0"><a href="#" class="btn btn-white py-md-4 py-3 px-md-5 px-4">Make An Appointment</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<p class="mb-0 msg">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
</div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4 d-flex">
                <div class="blog-entry justify-content-end" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
                    ...
                    <div class="text">
                        <p class="meta"><span><i class="fa fa-user me-1"></i>Admin</span> <span><i class="fa fa-calendar me-1"></i>Jan. 20, 2021</span> <span><a href="#"><i class="fa fa-comment me-1"></i> 3 Comments</a></span></p>
                        <h3 class="heading mb-3"><a href="#">How to keep your teeth always in the best condition</a></h3>
            ...
            <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
                <div class="block-7">
                    <div class="text-center">
                        ...
                        <span class="price"><sup>$</sup> <span class="number">89</span></span>
                        <ul class="pricing-text mb-3">
                            <li><span class="fa ion-ios-arrow-round-forward me-2"></span>Diagnostic Services</li>
                            <li><span class="fa ion-ios-arrow-round-forward me-2"></span>Professional Consultation</li>
                            <li><span class="fa ion-ios-arrow-round-forward me-2"></span>Tooth Implants</li>
