    ...
    <div class="col-md-12">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Lista de Especialidades</li>
            </ol>
        </nav>
        ...
        <div class="col-xl-12 col-md-12">
            <div class="ms-panel">
                <div class="ms-panel-header ms-panel-custome">
                    <h6>Lista de Especialidades</h6>
                    <a href="{{ route('admin.doctorspecialties.create') }}" class="ms-text-primary">Cadastrar
                        Especialidades</a>
                </div>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <a id="btn-details"
                                                            ...
                                                            href='{{ url("admin/doctores-especialidade/show/{$item->id}") }}'>
