...
@section('titulo', 'Cadastrar Recitas')
@section('content')
        <div class="row">
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb pl-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Cadastrar Receitas</li>
                    </ol>
                </nav>
            <div class="col-xl-12 col-md-12">
                <div class="ms-panel">
                    ...
                    <div class="ms-panel-body">
                        <form method="POST" class="needs-validation" novalidate action="{{ route('admin.prescriptions.store') }}">
                            @csrf
